...
def update_screen(ai_settings, screen ,ship,bullets,aliens,button,stats):
...
def check_play_button(mouse_x,mouse_y,stats,play_button,aliens,bullets,ship,screen,ai_setting):
